...
const selectedFilter = ref('Digital'); // Default value
...
<template>
    <div class="flex-1 flex flex-col bg-[#f8f9fd]">
        <div class="flex-1 flex flex-col justify-start items-center py-20">
            ...
            <div v-if="selectedFilter == 'Pernikahan'" class="w-full py-10 px-4 lg:px-72">
                <UtilsUndanganDigitalCategoryFilterCarousel />
            </div>
            <div class="py-10">
